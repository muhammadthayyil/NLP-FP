...
def main():
    ...
    argp.add_argument('--hyp_only', action='store_true',
                      help="For NLI: use hypothesis-only inputs (ignore the premise) to create an ablation model.")
    ...
    if args.task == 'qa':
        ...
        prepare_train_dataset = prepare_eval_dataset = \
            lambda exs: prepare_dataset_nli(exs, tokenizer, args.max_length, args.hyp_only)
